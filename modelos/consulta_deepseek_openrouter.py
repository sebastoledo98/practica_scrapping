...
async def procesar_sentimientos(data, batch_size):
    resultados_totales = []
    for i in range(0, len(data), batch_size):
        batch = data[i:i + batch_size]
        print(f"Procesando batch {i//batch_size + 1} de {len(data)//batch_size + 1}...")
...
async def analizar_comentarios(comentarios):
    print("--- Analizando con deepseek/deepseek-r1-0528 ---")
    ...
    prompt = (
        ...
        "Solo dame los resultados en el formato que te pido\n\n"
