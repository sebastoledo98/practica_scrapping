...
async def procesar_sentimientos(data):
    ...
    try:
        response = await client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "Eres un motor de análisis de sentimientos especializado en redes sociales."},
                {"role": "user", "content": prompt}
            ],
            # Aprovechamos que GPT-OSS soporta Structured Outputs
        ...
        return {"error": str(e), "comentario": data[:50]}

# Punto de entrada para probar con tus datos reales
