...
from instagram_scraper import iniciar_scrapping as ig_scraper
from twitter_scraper import iniciar_scrapping as tw_scraper
# from facebook_scraper import iniciar_scrapping as fb_scraper
# from linkedin_scraper import iniciar_scrapping as li_scraper
...
async def orquestador_principal(tema_busqueda):
    ...
    print(f"⏱️ Tiempo total de orquestación: {tiempo_fin_total - tiempo_inicio_total:.2f}s")
    print(f"📝 Volumen total del dataset: {total_comentarios} comentarios")
    print("—"*60)
